...
//            = LoggerFactory.getLogger(ByteProducer.class);
//
...
//
//    @Autowired
//    public ByteProducer(KafkaTemplate<String, GenericRecord> kafkaTemplate) {
...
//        this.avroKafkaTemplate.send(topicName,
//                ts+"",
//                record);
//        log.info(String.format("Produced genericRecord -> %s", record));
//    }
//}
